    ...
    if (offlineReady) {
      notificationsActions.push({
        options: {
          ...
          content: <Alert severity="success">You are ready to preview content offline.</Alert>,
        },
      });
    } else if (needRefresh) {
      notificationKey.current = notificationsActions.push({
        message: 'Updates are available, please click on reload button for the latest experience.',
        options: {
          variant: 'warning',
          persist: true,
          action: (
