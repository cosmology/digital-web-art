...
function SectionSubheader({ children, style = {} }: { children: React.ReactNode; style?: React.CSSProperties }) {
  ...
  //   >
  //     <div
  //       data-test-id={'inner sectipn wrapper'}
  //       style={{
...
const WelcomeContent = () => {
  return (
    <article>
      <p>You open a new browser tab, type in a URL, and press enter. The site loads instantly.</p>
    </article>
  );
};
...
const FrontEndContent = () => {
  return (
    <article>
      <p>It is all about who you are. I talk to you and translate your ideas to the screen.</p>
    </article>
  );
};
