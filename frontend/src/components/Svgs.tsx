...
export const getInteractiveSvgs = (fill: string, size: number, className?: string) => ({
  toBack: (
    <svg
      className={className}
  ...
  lightMode: (
    <svg className={className} height={size} viewBox="0 0 24 24" width={size} fill={fill}>
...
export const getCustomSvgs = (fill: string, h: number, w: number, titles: Types.SectionTitles, className?: string) => ({
  [titles.about]: (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" height={h} viewBox="0 0 24 24" width={w} fill={fill}>
      <path d="M0 0h24v24H0V0z" fill="none" />
...
export const IvanSvgScroll = ({ svgs, style = {} }: { svgs: JSX.Element[]; style?: any }) => {
...
export const SvgScroll = ({ svgs, style = {} }: { svgs: JSX.Element[]; style?: any }) => {
  return (
    <div
      style={{
        paddingTop: Const.pad,
...
export const SvgScroll2 = ({ svgs, style = {} }: { svgs: JSX.Element[]; style?: any }) => {
  return (
    <div
      style={{
        paddingTop: Const.pad,
    ...
    >
      <div>
        ...
        <div style={{ display: 'flex', paddingLeft: 58, paddingTop: 20 }}>
          {svgs.slice(Math.floor(svgs.length / 2), svgs.length - 1).map((s, i) => (
            <div key={i}>{s}</div>
          ))}
        </div> */}
      </div>
...
export const getSvgFromSimpleIcon = (ico: any, size: number, color?: string) => {
  return (
    <svg viewBox="0 0 24 24" height={size} width={size} fill={color ? color : `#${ico.color}`}>
      {' '}
...
export const getSimpleSvgs = (size: number, themeName: string, wrapped = true, icons: Types.SimpleIcon[]) => {
